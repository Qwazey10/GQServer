...
-- Dumping structure for table character_gquest.character_inventory
CREATE TABLE IF NOT EXISTS `character_inventory` (
  `guid` bigint(20) DEFAULT NULL,
  `character_name` varchar(50) DEFAULT NULL,
  `slot_1` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='character inventory and equipment tracker, this will be govered largely by the server, minimal manual editing\r\n';
